...
basis = np.load('../basis/basis_single_fold1_bg.npy')
print(x_train.shape)
print(basis.shape)
...
basis = np.load('../basis/basis_single_fold2_bg.npy')
print(x_train.shape)
print(basis.shape)
basis = np.transpose(basis)
m = np.mean(x_train,axis=0)
...
basis = np.load('../basis/basis_single_fold3_bg.npy')
print(x_train.shape)
print(basis.shape)
basis = np.transpose(basis)
m = np.mean(x_train,axis=0)
...
basis = np.load('../basis/basis_single_fold4_bg.npy')
print(x_train.shape)
print(basis.shape)
basis = np.transpose(basis)
m = np.mean(x_train,axis=0)
