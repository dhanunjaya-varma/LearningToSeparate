...
input_path = '../feat/cross_val/audio/fold1/train/' 
...
np.save("../data/x_audio_fold1_train.npy", x_fold1_train)
np.save("../data/y_audio_fold1_train.npy", y_fold1_train)  

input_path = '../feat/cross_val/audio/fold1/test/' 
#output='/home/dhanunjaya/Documents/DCASE17/mel_spec/audio/'
...
np.save("../data/x_audio_fold1_test.npy", x_fold1_test)
np.save("../data/y_audio_fold1_test.npy", y_fold1_test)  

########fold2

input_path = '../feat/cross_val/audio/fold2/train/' 
#output='/home/dhanunjaya/Documents/DCASE17/mel_spec/audio/'
...
np.save("../data/x_audio_fold2_train.npy", x_fold2_train)
np.save("../data/y_audio_fold2_train.npy", y_fold2_train)  

input_path = '../feat/cross_val/audio/fold2/test/' 
#output='/home/dhanunjaya/Documents/DCASE17/mel_spec/audio/'
...
np.save("../data/x_audio_fold2_test.npy", x_fold2_test)
np.save("../data/y_audio_fold2_test.npy", y_fold2_test) 

####fold3

input_path = '../feat/cross_val/audio/fold3/train/' 
#output='/home/dhanunjaya/Documents/DCASE17/mel_spec/audio/'
...
np.save("../data/x_audio_fold3_train.npy", x_fold3_train)
np.save("../data/y_audio_fold3_train.npy", y_fold3_train)  

input_path = '../feat/cross_val/audio/fold3/test/' 
#output='/home/dhanunjaya/Documents/DCASE17/mel_spec/audio/'
...
np.save("../data/x_audio_fold3_test.npy", x_fold3_test)
np.save("../data/y_audio_fold3_test.npy", y_fold3_test) 

###fold4
input_path = '../feat/cross_val/audio/fold4/train/'
#output='/home/dhanunjaya/Documents/DCASE17/mel_spec/audio/'
...
np.save("../data/x_audio_fold4_train.npy", x_fold4_train)
np.save("../data/y_audio_fold4_train.npy", y_fold4_train)  

input_path = '../feat/cross_val/audio/fold4/test/'
#output='/home/dhanunjaya/Documents/DCASE17/mel_spec/audio/'
...
np.save("../data/x_audio_fold4_test.npy", x_fold4_test)
np.save("../data/y_audio_fold4_test.npy", y_fold4_test)